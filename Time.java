...
public class Time implements DateConstants{
	...
	public Time(int hour, int minute, int second, int hundredth) {
		...
		if (!isValid(hour, minute, second, hundredth))
			throw new RuntimeException("1: Invalid time " + hour + ":" + minute + ":" + second + ":" + hundredth);
...
/**
	 * Constructor: creates a valid time objectwith a string in hh:mm format as a string;
	 * 
	 * 
	 *            
	 * 
	...
	public Time(String aTime) {
        ...
        this(Integer.parseInt(aTime.split(":")[ZEROI]), Integer.parseInt(aTime.split(":")[ONEI]), ZEROI, ZEROI);	
	}
	...
	private Time hundredthToTime(int hundredths) {
		...
		if (!isValid(tmpHour, tmpMinute, tmpSecond, tmpHundredth))
			throw new RuntimeException("2: Invalid time" + hour + ":" + minute + ":" + second + ":" + hundredth);
    ...
    Time addHundredth(int hundredth) {
		...
		if (hundredth < 0)
			throw new RuntimeException("5: Invalid hundredths of a second" + hundredth);
	...
	public static void main(String[] args) {
		...
		System.out.println(t1 + " is after " + t1.addHour().addHour().subtractTime(new Time(1, 0, 0, 0)) + ": " 
                            + t1.isAfter(t1.addHour().addHour().subtractTime(new Time(1, 0, 0, 0))));
